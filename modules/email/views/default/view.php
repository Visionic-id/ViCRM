        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="embed-responsive embed-responsive-1by1">
                    <iframe class="embed-responsive-item" src="<?= Url::to(['view-raw', 'id'=>$model->id]) ?>"></iframe>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                foreach($model->emailMailboxAttachments as $attachment){
                    ?>
                    <li class="list-group-item"><a href="<?= Url::to(['/email/default/download-attachment', 'id'=>$attachment->id]) ?>"><?= $attachment->name ?></a></li>
                    <?php
                }
                ?>
                </ol>
